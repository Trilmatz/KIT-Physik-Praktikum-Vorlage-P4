...
\newcommand{\praktikum}{P4} %Praktikum P3/P4:
\newcommand{\gruppennummer}{34} %Gruppennummer:
\newcommand{\gruppentag}{Mo1} % Gruppentag (Mo1, Mo2, Mi3):
...
\newcommand{\semester}{SS23} %Semester:
\newcommand{\versuch}{} %Versuch:
\newcommand{\nameeins}{Frohn, Marius} %Name1 (Vor und Nachname):
\newcommand{\emaileins}{} %E-Mail 1:
\newcommand{\namezwei}{Grimm, Leander} %Name2 (Vor und Nachname):
\newcommand{\emailzwei}{leander.grimm@student.kit.edu} %E-Mail 2:
